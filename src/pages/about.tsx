...
const AboutPage = () => {
  return (
    <Layout title="Our Story">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-brand-charcoal/70 leading-relaxed">
                Founded in 2018, Banaya was born out of a passion for the natural beauty of wood and a desire to bring timeless craftsmanship into the modern Indian home. We believe that furniture isn't just a utility—it's the soul of a space.
              </p>
              <p className="text-lg text-brand-charcoal/70 leading-relaxed">
                Every piece we create is a result of months of design iteration and the skilled hands of our master craftsmen. We source only the finest sustainable walnut, teak, and oak, ensuring that your investment lasts for generations.
              </p>
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div>
                  <h4 className="text-3xl font-serif font-bold text-brand-gold">100%</h4>
                  <p className="text-sm uppercase tracking-widest text-brand-neutral">Sustainable Wood</p>
                </div>
                <div>
                  <h4 className="text-3xl font-serif font-bold text-brand-gold">50+</h4>
                  <p className="text-sm uppercase tracking-widest text-brand-neutral">Master Artisans</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Mission */}
      <section className="py-24 bg-brand-walnut text-brand-ivory">
        <div className="container mx-auto px-4 md:px-8 text-center max-w-4xl">
          <h2 className="text-4xl font-serif font-bold mb-8">Our Mission</h2>
          <p className="text-2xl font-serif italic text-brand-beige leading-relaxed mb-12">
