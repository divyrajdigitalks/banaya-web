...
export const FEATURED_PRODUCTS = [
  ...
  },
  {
    ...
    hoverImage: "https://images.unsplash.com/photo-1519947486511-46149fa0a254?auto=format&fit=crop&q=80&w=800",
    tag: "New",
  },
  {
    id: "p3",
...
export const TESTIMONIALS = [
  {
    ...
    content: "The quality of craftsmanship at Banaya is unparalleled. Every piece I've ordered for my clients has been a conversation starter.",
    rating: 5,
  },
  {
    id: "t2",
    name: "Vikram Mehta",
    role: "Architect",
    content: "Minimalist, modern, and sturdy. Banaya perfectly balances aesthetics with functionality. Highly recommended for premium homes.",
    rating: 5,
  },
  {
    id: "t3",
    name: "Priya Iyer",
    role: "Home Owner",
    content: "I love the warm walnut finish on my new dining table. It's transformed our space into a cozy yet luxury sanctuary.",
    rating: 4,
  },
];
